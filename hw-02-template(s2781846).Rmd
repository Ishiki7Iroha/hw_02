...
knitr::include_graphics("good_visulization.png")
```
...
**Don't know**, "**https://chartexpo.com/blog/?p=27756**" [Online]. Available at: **URL** (Accessed: **day month year**)


The above image presents a good data visualisation because:

-   The x-axis and y-axis are labled easily to read
-   The trend is shown clearly on the graph
...
# edit the file path accordingly
knitr::include_graphics("909.png")
```

_Edit the text below by replacing the bold text with the appropriate information to provide a reference for your image (Please delete this message before submission!)_

**fredwhipp.wordpress**, "**https://fredwhipp.wordpress.com/2020/10/24/example-post-2/**" [Online]. Available at: **https://fredwhipp.wordpress.com/2020/10/24/example-post-2/** (Accessed: **day month year**)



The above image presents a bad data visualisation because:

-   Too many data makes it impossible to read
-   Needs to be more colorful for people to distinguish different box.
